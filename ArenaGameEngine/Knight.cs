...
namespace ArenaGameEngine
{
    ...
    {
        public Knight(string name) : this(name, 50) //By default, all knights are named 'Sir John'
        {

        }

        public Knight(string name, int strenght) : base(name, strenght) //A named knight, we supply the name
        {
            hitCount = 0;
        }
